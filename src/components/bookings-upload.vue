...
export default {
  ...
  async mounted() {
    const crossingId = this.crossingId
    // Make sure we are dealing with the correct crossing
...
<template>
  <div :class="$style.container">
    ...
    <Transition name="slide-fade" mode="out-in">
      ...
      <div v-if="uploadInputState !== BUTTON_STATES.VALID_FILE" key="uploader">
...
.container {
  // Don't add any padding on the sides you would break the layout
  padding-top: 2rem;
  padding-bottom: 2rem;
}
